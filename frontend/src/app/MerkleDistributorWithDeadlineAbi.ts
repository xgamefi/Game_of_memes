export const MerkleDistributorWithDeadlineAbi = [
  {
    "type": "constructor",
    "inputs": [
  ...
  { "type": "error", "name": "ClaimWindowFinished", "inputs": [] },
  { "type": "error", "name": "EndTimeInPast", "inputs": [] },
  { "type": "error", "name": "InvalidProof", "inputs": [] },
  { "type": "error", "name": "NewEndTimeInPast", "inputs": [] },
  { "type": "error", "name": "NoWithdrawDuringClaim", "inputs": [] },
  {
    "type": "error",
